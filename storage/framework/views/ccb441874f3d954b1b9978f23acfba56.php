                ...
                <div class="button-row-actions" style="display: flex; gap: 12px; align-items: center;">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-warning dropdown-toggle" data-bs-toggle="dropdown"
                            aria-expanded="false">
                        <?php echo e(__("labels.action")); ?>

                        </button>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item action-cls" href="javascript:void(0);" data-action="forward"><?php echo e(__("labels.forward")); ?></a></li>
                            
                            <?php if($details->application->allot_auth == Auth::user()->user_type): ?>
                            <li><a class="dropdown-item action-cls" href="javascript:void(0);" data-action="cancel"><?php echo e(__("labels.cancel")); ?></a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                    <form id="actionForm" action="<?php echo e(route('transaction.action')); ?>" method="POST" style="display:none;">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="action" id="actionInput">
                        <input type="hidden" name="transaction_id" value="<?php echo e($details->id); ?>">
                    </form>
                    <?php endif; ?>
                </div>
                    ...
                    <div class="card h-100 shadow-sm applicant-card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <span>
                                ...
                                <?php echo e(__("labels.application_details")); ?> - (<?php echo e($details->application->application_number); ?>)
                            </span>
                        ...
                        <div class="card-body">
                            <div class="container-fluid p-0">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="detail-row">
                                            ...
                                            <div class="detail-value"><?php echo e($details->application->rule->application_rule_name ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="detail-row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="detail-row">
                                            ...
                                            <div class="detail-value"><?php echo e($details->application->purpose->purpose_name ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="detail-row">
                                            ...
                                            <div class="detail-value"><?php echo e($details->application->applicant_name ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="detail-row">
                                            <div class="detail-label"><?php echo e(__("labels.app_fa_name")); ?>:</div>
                                            <div class="detail-value"><?php echo e($details->application->applicant_fname ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="detail-row">
                                            ...
                                            <div class="detail-value"><?php echo e($details->application->landOwnerDetail[0]->owner_name ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="detail-row">
                                            <div class="detail-label"><?php echo e(__("labels.land_type")); ?>:</div>
                                            <div class="detail-value"><?php echo e($details->application->landDetail->land_type ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="detail-row">
                                            ...
                                            <div class="detail-value"><?php echo e($details->application->applicant_add1 ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="detail-row">
                                            <div class="detail-label"><?php echo e(__("labels.owner_address")); ?>:</div>
                                            <div class="detail-value"><?php echo e($details->application->landOwnerDetail[0]->owner_add1 ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            <div class="detail-label"><?php echo e(__("labels.district_name")); ?>:</div>
                                            <div class="detail-value"><?php echo e($details->application->district->District_Name ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            <div class="detail-label"><?php echo e(__("labels.khatedar_tehsil")); ?>:</div>
                                            <div class="detail-value"><?php echo e($details->application->tehsil->Block_Name ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            <div class="detail-label"><?php echo e(__("labels.village")); ?>:</div>
                                            <div class="detail-value"><?php echo e($details->application->landDetail->village->Village_Name ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">                                    
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            ...
                                            <div class="detail-value"><?php echo e($details->application->landOwnerDetail[0]->khasra_number ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            <div class="detail-label"><?php echo e(__("labels.proposed_area")); ?>:</div>
                                            <div class="detail-value"><?php echo e($details->application->landDetail->proposed_land_area ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            <div class="detail-label"><?php echo e(__("labels.is_land_surr")); ?>:</div>
                                            <div class="detail-value"><?php echo e(($details->application->landDetail->is_land_surrendered == 'no') ? "No" : "Yes"); ?></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            ...
                                            <div class="detail-value"><?php echo e(($details->application->landDetail->irrigation_land) ? ucfirst($details->application->landDetail->irrigation_land) : 'N/A'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            <div class="detail-label"><?php echo e(__("labels.national_highway_distance")); ?>:</div>
                                            <div class="detail-value"><?php echo e($details->application->landDetail->dist_from_NH ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            <div class="detail-label"><?php echo e(__("labels.state_highway")); ?>:</div>
                                            <div class="detail-value"><?php echo e($details->application->landDetail->dist_from_SH ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">                                    
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            ...
                                            <div class="detail-value"><?php echo e($details->application->landDetail->dist_from_RL ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            <div class="detail-label"><?php echo e(__("labels.distance_from_town_city")); ?>:</div>
                                            <div class="detail-value"><?php echo e($details->application->landDetail->dist_from_City ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            <div class="detail-label"><?php echo e(__("labels.applicant_type")); ?>:</div>
                                            <div class="detail-value"><?php echo e($details->application->applicant_type ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="detail-row">
                                            ...
                                            <div class="detail-value"><?php echo e($details->application->landDetail->irrigation_detail ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-body" style="padding:25px 24px 22px 24px;">
                            <div class="table-responsive">
                                <table class="table mb-0" style="font-size:15.2px; border-collapse:separate;">
                                    ...
                                    <tbody>
                                        <?php $i = 1; ?>
                                        <?php $__empty_1 = true; $__currentLoopData = $details->application->applicationDocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php echo $__env->make('layouts.front_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xamppp\htdocs\RALAMS_New_Updated_Code\resources\views/applicant_detail.blade.php ENDPATH**/ ?>