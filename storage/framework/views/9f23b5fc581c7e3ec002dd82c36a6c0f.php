                                        ...
                                        <div class="row card-body pt-4" style="">
                                            <div class="col-md-6" align="left">
                                                <label for="purpose_type"
                                                    class="form-label"><?php echo e(__('labels.applicant_purpose')); ?>
...
unset($__errorArgs, $__bag); ?>">
                                                    ...
                                                    <?php $__currentLoopData = $purposes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($item->id); ?>"
                                                            ...
                                                            <?php echo e(old('allotment_purpose') == $item->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                                    value="<?php echo e(old('purpose_details')); ?>">
                                        ...
                                        <div class="row card-body mb-4">
                                                ...
                                                <div class="inline-radio">
                                                    <label>
                                                        <input type="radio" name="applicant_type" id="personal"
                                                            value="personal" checked> <?php echo e(__('labels.personal')); ?>
                                            ...
                                            <div class="col-md-4 mt-4" align="left" id="app_name" style="display:none;">
                                                ...
                                                <input type="text" id="app_name"
                                                    data-label="<?php echo e(__('labels.applicant_name')); ?>" name="app_name"
                                                    placeholder="<?php echo e(__('labels.applicant_name')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-md-4" align="left" id="app_fname" style="display:none;">
                                                ...
                                                <input type="text" id="app_fname"
                                                    data-label="<?php echo e(__('labels.applicant_father_name')); ?>"
                                                    name="app_fname" align="left"
                                                    placeholder="<?php echo e(__('labels.applicant_father_name')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="row card-body">
                                            <div class="col-md-6 mt-4" align="left" id="land_alloted_details"
                                                style="display:none;">
                                                <label
                                                    for="land_alloted_details"><?php echo e(__('labels.land_alloted_details')); ?><span
                                                        style="color: red;">*</span></label>
...
unset($__errorArgs, $__bag); ?>"
                                                    value="<?php echo e(old('land_alloted_details')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-md-6 mt-4" align="left" id="project_report"
                                                ...
                                                <input type="text" name="project_report" class="form-control"
                                                    value="<?php echo e(old('project_report')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                                    value="<?php echo e(old('society_benefits')); ?>">
                                            ...
                                            <div class="col-md-6 mt-4" align="left" id="experience"
                                                style="display:none;">
                                                <label><?php echo e(__('labels.org_experience')); ?><span
                                                        style="color: red;">*</span></label>
                                                <div class="d-flex gap-3 align-items-center">
                                                    <div class="form-check">
                                        ...
                                        <div class="row card-body" id="registration-fields">
                                            <div class="col-md-4 mt-4" align="left" id="inst_reg_registrar"
                                                style="display:none;">
                                                <label
                                                    for="inst_reg_registrar"><?php echo e(__('labels.inst_reg_registrar')); ?></label><span
                                                    style="color: red;">*</span>
                                                <!-- <textarea class="form-control mb-2" name="inst_reg_registrar" rows="3"></textarea> -->
                                                <label
                                                    for="income_expenditure"><?php echo e(__('labels.income_expenditure')); ?></label>
                                        ...
                                        <div class="row card-body pt-4 pb-5">
                                            ...
                                            <div class="col-md-6 mt-4" align="left">
                                                ...
                                                <input class="form-control" id="type_of_land" type="text"
                                                    placeholder="<?php echo e(__('labels.type_of_land')); ?>" name="type_of_land">
                                            ...
                                            <div class="col-md-6 mt-4" align="left">
                                                ...
                                                <input class="form-control onlyNumber" id="proposed_area" type="text"
                                                    placeholder="<?php echo e(__('labels.proposed_area')); ?>" name="proposed_area"
                                                    maxlength="3">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $documentTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div id="file_<?php echo e($key); ?>" class="file-wrapper">
                                                                    <input type="file"
                                                                    ...
                                                                    <span id="<?php echo e($document->document_details); ?>_error"
                                                                        style="color: red;"></span>
                                                                </div>
                                                            </td>
                                                        </tr>
...
<?php echo $__env->make('layouts.front_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xamppp\htdocs\RALAMS_New_Updated_Code\resources\views/new-application.blade.php ENDPATH**/ ?>