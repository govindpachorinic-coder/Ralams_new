                                ...
                                <div class="row card-body pt-4 pb-5">
                                    ...
                                    <div class="col-md-6 mt-3" align="left">
                                        <label for="village">{{ __('labels.village') }}<span
                                                style="color: red;">*</span></label>
                                        <select name="village" id="village_id" class="form-control" onchange="changeVillage(this)" required>
                                    ...
                                    <div class="col-md-6 mt-4" align="left">
                                        ...
                                        <input class="form-control" id="proposed_area" type="text"
                                            placeholder="{{ __('labels.proposed_area') }}" name="proposed_area" value="{{$application->landDetail->proposed_land_area}}">
                                ...
                                <div class="row card-body mb-3">
                                    <div class="col-md-6 mt-4" align="left">
                                        <label for="project_cost">{{ __('labels.project_cost') }}<span
                                                style="color: red;">*</span></label>
                                        <input class="form-control" type="text" id="project_cost" name="project_cost" value="{{$application->landDetail->project_cost}}"
                                                    ...
                                                    <td>
                                                        ...
                                                        <div id="file_{{ $key }}" class="file-wrapper" style="{{$documentcss}}">
                                                            ...
                                                            <small class="error" style="color:red; display:block; margin-top:4px;"></small>
                                                                ...
                                                                <a href="{{$doc->document_file}}" id="{{$doc->id}}" title="Download" download><i class="fa fa-download"></i></a>
                                                                @endif
                                                        </div>
                                                    </td>
                                                </tr>                                                
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(khasraList, function(index, k) {
                            ...
                            let isSelected = $.inArray(k.khasra, selectedKhasras) !== -1 ? 'selected' : '';                                                                   
                            $('#khsra').append(`
