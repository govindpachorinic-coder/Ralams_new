...
@section('content')
                        ...
                        <form action="" onsubmit="return validateFormss()" id="ralamsForm" name="myForm">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-12 mt-4" id="org_status" style="display:none;">
                                    <div class="form-group">
                                        <label>आवेदक का प्रकार:</label><br>
                                        <label>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-6 mt-4">
                                                        ...
                                                        <input class="form-control" id="proposed_area" type="text"
                                                            placeholder="प्रस्तावित क्षेत्रफल" name="proposed_area">
                                                ...
                                                <div class="row mt-4">
                                                    ...
                                                    <div class="col-md-6 d-flex align-items-center flex-wrap gap-3">
                                                        ...
                                                        <div id="landSurrDetails" class="mt-2"
                                                            ...
                                                            <textarea id="landSurrenderTextarea"
                                                                name="land_surrender_description" class="form-control mt-2"
                                                                placeholder="विवरण" style="min-width: 250px;"></textarea>
                                                            <label id="land_surrender_description-error" class="error"
                                                                for="landSurrenderTextarea"></label>
                                                        </div>
                                                    </div>
    ...
    <button type="button" id="land_details" class="collapsible btn-custom">
                ...
                <div class="card card-registration card-registration-2" style="border-radius: 15px;">
                    <div class="card-body">
                        <form action="" method="post" id="LandDetailform" name="LandDetailform"
                            ...
                            <div class="mt-4 d-flex justify-content-center">
                                <button type="submit" class="btn btn-primary d-flex align-items-center gap-2" name="action"
                                    value="save" id="saveBtn">
                                    <span>{{ __("labels.save") }}</span>
                                </button>

                                <!-- <button type="submit" class="btn btn-success d-flex align-items-center gap-2" name="action"
                                                    value="update" id="updateBtn" disabled>
                    ...
                    <div class="card-body">
                        <form action="" method="post" id="DocumentsUploadform" name="DocumentsUploadform"
                            ...
                            <div class="mt-4 d-flex justify-content-center">
                                ...
                                <button type="submit" class="btn btn-primary d-flex align-items-center gap-2" name="    "
                                    value="save" id="saveBtnDoc">
                                    <span>{{ __("labels.save") }}</span>
                                </button>

                                <!-- <button type="submit" class="btn btn-success d-flex align-items-center gap-2" name="action_doc"
                                                    value="update" id="updateBtnDoc" disabled>
                                                    <span>{{ __("labels.update") }}</span>
                                                </button> -->
    ...
    <script src="{{ asset('application_assets/js/jquery.validate.min.js') }}"></script>
    <script src="{{ asset('js/land_validation.js') }}"></script>
    ...
    <script>
        ...
        $('#purpose_types').on('change', function () {
            ...
            // Set the rule based on purposeTypeId
