                    ...
                    <div class="card h-100 shadow-sm applicant-card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <span>
                                ...
                                {{ __("labels.application_details") }} - ({{ $details->application_number }})
                            </span>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="detail-row">
                                            ...
                                            <div class="detail-value">{{$details->rule->application_rule_name ?? 'N/A'}}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="detail-row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="detail-row">
                                            ...
                                            <div class="detail-value">{{ $details->purpose->purpose_name ?? 'N/A'}}</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="detail-row">
                                            ...
                                            <div class="detail-value">{{ $details->applicant_name ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="detail-row">
                                            <div class="detail-label">{{ __("labels.app_fa_name") }}:</div>
                                            <div class="detail-value">{{ $details->applicant_fname ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="detail-row">
                                            ...
                                            <div class="detail-value">{{ $details->landOwnerDetail[0]->owner_name ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="detail-row">
                                            <div class="detail-label">{{ __("labels.land_type") }}:</div>
                                            <div class="detail-value">{{ $details->landDetail->land_type ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="detail-row">
                                            ...
                                            <div class="detail-value">{{ $details->applicant_add1 ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="detail-row">
                                            <div class="detail-label">{{ __("labels.owner_address") }}:</div>
                                            <div class="detail-value">{{ $details->landOwnerDetail[0]->owner_add1 ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            ...
                                            <div class="detail-value">{{ $details->landDetail->village->Village_Name ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            <div class="detail-label">{{ __("labels.khasra_no") }}:</div>
                                            <div class="detail-value">{{ $details->landOwnerDetail[0]->khasra_number ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            <div class="detail-label">{{ __("labels.proposed_area") }}:</div>
                                            <div class="detail-value">{{ $details->landDetail->proposed_land_area ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            ...
                                            <div class="detail-value">{{ ($details->landDetail->is_land_surrendered == 'no') ? "No" : "Yes"  }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            <div class="detail-label">{{ __("labels.irrigation_land") }}:</div>
                                            <div class="detail-value">{{ ($details->landDetail->irrigation_land) ? ucfirst($details->landDetail->irrigation_land) : 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            <div class="detail-label">{{ __("labels.national_highway_distance") }}:</div>
                                            <div class="detail-value">{{ $details->landDetail->dist_from_NH ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            ...
                                            <div class="detail-value">{{ $details->landDetail->dist_from_SH ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            <div class="detail-label">{{ __("labels.railway_distance") }}:</div>
                                            <div class="detail-value">{{ $details->landDetail->dist_from_RL ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="detail-row">
                                            <div class="detail-label">{{ __("labels.distance_from_town_city") }}:</div>
                                            <div class="detail-value">{{ $details->landDetail->dist_from_City ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="detail-row">
                                            ...
                                            <div class="detail-value">{{ $details->landDetail->irrigation_detail ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-body" style="padding:25px 24px 22px 24px;">
                            <div class="table-responsive">
                                <table class="table mb-0" style="font-size:15.2px; border-collapse:separate;">
                                    ...
                                    <tbody>
                                        @php $i = 1; @endphp
                                        @forelse($details->applicationDocs as $doc)
                    ...
                    <div class="card h-100 shadow-sm"
                        ...
                        <div class="card-body" style="padding:25px 27px 22px 27px;">
                            <div class="proposal-history-list"
                                ...
                                @forelse($details->applicationTransactions as $transaction)
