$(document).ready(function () {
    ...
    $("#applicant-form").validate({
        rules: {
            ...
            app_mobile: { required: true, digits: true, minlength: 10, maxlength: 10 },
            ...
            society_benefits_file: { required: "#society_benefits_file:visible" },
            ...
            org_reg_certificate_file: { required: "#org_reg_certificate_file:visible" }
        },
        messages: {
            ...
            land_alloted_details: window.validationMessages.land_alloted_details,
            ...
            org_reg_certificate_file: window.validationMessages.org_reg_certificate_file,
            experience_detail: window.validationMessages.experience_detail,
            prev_allot_land_file: window.validationMessages.prev_allot_land_file,
            reg_number: window.validationMessages.reg_number,
            reg_date: window.validationMessages.reg_date,
            society_benefits_file: window.validationMessages.society_benefits_file
        }
    });
    ...
    $("#land_detail_form").validate({
        ...
        messages: {
            ...
            national_highway_distance: window.validationMessages.national_highway_distance,
            state_highway: window.validationMessages.state_highway,
            distance_from_town_city: window.validationMessages.distance_from_town_city,
